...
{
    public class StudentGuardianRepository : BaseRepository<StudentGuardian>, IStudentGuardianRepository
    {
        public StudentGuardianRepository(MySchoolContext context)
            : base(context)
        {
